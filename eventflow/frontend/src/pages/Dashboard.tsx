      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
        ...
        <div className="card overflow-hidden xl:col-span-2">
          <div className="border-b border-[var(--color-border)] px-6 py-4">
            <h3 className="text-sm font-semibold text-[var(--color-fg)]">High-risk corridors</h3>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[var(--color-border)] text-left">
                  <th className="px-6 py-3 text-[11px] font-semibold uppercase tracking-wider text-[var(--color-subtle)]">Corridor</th>
                  <th className="px-4 py-3 text-[11px] font-semibold uppercase tracking-wider text-[var(--color-subtle)]">Events</th>
                  <th className="px-4 py-3 text-[11px] font-semibold uppercase tracking-wider text-[var(--color-subtle)]">Score</th>
                  <th className="px-6 py-3 text-[11px] font-semibold uppercase tracking-wider text-[var(--color-subtle)]">Closure</th>
                </tr>
              </thead>
              <tbody>
                {corridors.map((c, i) => (
                  <tr key={c.corridor} className={i < corridors.length - 1 ? 'border-b border-[var(--color-border)]' : ''}>
                    <td className="px-6 py-3.5 font-medium text-[var(--color-fg)]">{c.corridor}</td>
                    <td className="px-4 py-3.5 font-mono text-xs text-[var(--color-muted)]">{c.count}</td>
